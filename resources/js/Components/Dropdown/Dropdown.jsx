    ...
    return (
        ...
        >
            <div className='inputs_item stand_input' >
                <div className={`icon_float ${isClick ? "is_change" : ""}`}><img className={'icon_'} src={icon}/></div>
            ...
            >
                ...
                <ul>
                    ...
                    {
                        return <li className='stand_input' key={index} onClick={() => { setIsTitle(item); onChange(item) }} style={{ ...props.itemStyle }} >{item.name ? item.name : ""}</li>
                    })}
